...
CREATE TABLE DYZUR (
	...
	FOREIGN KEY(ID_APTEKA) REFERENCES APTEKA(ID) ON DELETE CASCADE,
	FOREIGN KEY(ID_FARMACEUTA) REFERENCES FARMACEUTA(ID) ON DELETE CASCADE
);
...
CREATE TABLE ZAMOWIENIE (
	...
	FOREIGN KEY (ID_KLIENT) REFERENCES KLIENT(ID) ON DELETE CASCADE,
	PRIMARY KEY(ID)
);
...
CREATE TABLE LEKARSTWA (
	...
	FOREIGN KEY(ID_ZAMOWIENIE) REFERENCES ZAMOWIENIE(ID) ON DELETE CASCADE,
	FOREIGN KEY(ID_LEKARSTWO) REFERENCES LEK(ID) ON DELETE CASCADE
);
